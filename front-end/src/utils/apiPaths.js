...
export const API_PATHS = {
  ...
  TASKS: {
    ...
    GET_ALL_TASKS: "/api/tasks", // Get all tasks (Admin/User)
...
REPORTS: {
    EXPORT_TASKS: "/api/reports/export/tasks", // Export tasks as CSV
    EXPORT_USERS: "/api/reports/export/users", // Export users as CSV
},
